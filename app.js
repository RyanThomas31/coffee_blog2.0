...
ejs.delimiter = '?';
mongoose.connect('mongodb://ryan2:timeflies31@ds249311.mlab.com:49311/coffee_talk', {useMongoClient: true});

// PASSPORT CONFIG
app.use(require("express-session")({ secret: "RockieRocko is the boss here", resave: false, saveUninitialized: false })); 
...
app.get('/blogs/firstpage', function(req, res) {
  Blog.find({}, function(err, blogs) {
    if (err) {
      console.log('ERROR:', err);
    } else {
      res.render('firstpage', {blogs: blogs});
    }
  });
});
